...
public class SergeyIOHandler extends GraphIOHandler {
    ...
    public static Graph read(String inputFileName) throws IOException
    {
        ...
        for (int l =0; l < lines.length; l++) {
            ...
            if (l == 0) {
                ...
                edges = new int[Integer.parseInt(source[1])][Integer.parseInt(source[1])];
    ...
    public static void write(Graph graph, String outputFileName) throws IOException
    {
        ...
        boolean[][] edges = new boolean[graph.N()][graph.N()];
    ...
    {
        try {
            SergeyIOHandler shandler = new SergeyIOHandler();
            Graph g = shandler.read("C:\\Users\\Michael\\Desktop\\sergey_graph.edges");
            System.out.println(g.N() + " " + g.E());
            System.out.println(g);
            ChristianIOHandler chandler = new ChristianIOHandler();
            chandler.write(g, "C:\\Users\\Michael\\Desktop\\sergey_graph.amf");
        }
        catch (Exception exc)
        {
            exc.printStackTrace();
