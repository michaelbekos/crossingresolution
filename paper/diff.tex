...
%DIF ADD journal.tex     Fri Jul 26 10:21:36 2019
...
%DIFDELCMD < %%%
\DIFdel{Note that, in general }\DIFdelend \DIFaddbegin \DIFadd{Note at that in general the vertex movement paradigm is an established technique and has successfully applied to graph theoretic and geometric problems; see, e.g.,~\mbox{%DIFAUXCMD
...
\begin{table*}
\caption{Summary of the results for the Graph Drawing Contest \DIFdelbeginFL \DIFdelFL{2017.}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2017; the last two columns correspond to results presented in this paper (with and without time limitations, respectively).}\DIFaddendFL }
\centering
...
Giacomo, E.~D., Didimo, W., Liotta, G., and Meijer, H. (2011) Area, curve
...
Giacomo, E.~D., Didimo, W., Eades, P., and Liotta, G. (2014) 2-layer right
  angle crossing drawings.
...
\DIFdel{abs/1807.09483}\DIFdelend \DIFaddbegin \bf11282}\DIFadd{,  pp. 286--299. Springer.
}
...
\DIFadd{Devanny, W.~E., Kindermann, P., L}{\DIFadd{\"{o}}}\DIFadd{ffler, M., and Rutter, I. (2018) Graph
  ...
  Visualization}}\DIFadd{,  LNCS, }{\bf11282\DIFaddend }\DIFaddbegin \DIFadd{,  pp. 609--617. Springer}\DIFaddend .
