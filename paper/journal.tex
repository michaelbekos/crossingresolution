...
\begin{figure*}[t]
	...
	\includegraphics[scale=0.99,page=13]{figures/rome}}
	\hfil
	\subfloat[\label{fig:cr-res-2}{Edge-length ratio vs no.~of vertices}]{
	\includegraphics[scale=0.99,page=14]{figures/rome}}
	
	\subfloat[\label{fig:cr-res-3}{No.~of crossings vs no.~of vertices}]{
	\includegraphics[scale=0.99,page=15]{figures/rome}}
	\hfil
	\subfloat[\label{fig:cr-res-4}{No.~of iterations vs no.~of vertices}]{
	\includegraphics[scale=0.99,page=16]{figures/rome}}
