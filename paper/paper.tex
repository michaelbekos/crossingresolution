...
(a)--(c)~our algorithm, 
(d)--(f)~the algorithm by Argyriou et al.~\cite{DBLP:journals/cj/ArgyriouBS13}, and
(g)--(i)~the algorithm by Huang et al.~\cite{DBLP:journals/vlc/HuangEHL13}.
