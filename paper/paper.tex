...
\caption{Drawings of graph 5 from last years graph drawing contest.  
%(a)~Organic Layout by \emph{yFiles}, 
(a)--(c)~Our results, 
(d)--(f)~Results computed with Argyriou et al.~\cite{DBLP:journals/cj/ArgyriouBS13}, 
(g)--(i)~Results computed with Huang et al~\cite{DBLP:journals/vlc/HuangEHL13}.}
\label{fig:graph5}
\end{figure}
...
\caption{Drawings of graph 9 from last years graph drawing contest. 
%(a)~Organic Layout by \emph{yFiles}, 
(a)--(c)~Our results, 
(d)--(f)~Results computed with Argyriou et al.~\cite{DBLP:journals/cj/ArgyriouBS13}, 
(g)--(i)~Results computed with Huang et al~\cite{DBLP:journals/vlc/HuangEHL13}.}
