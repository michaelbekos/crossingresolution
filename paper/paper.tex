...
\legend{{$1M \times 1M$},{$10k \times 10k$},{$1k \times 1k$},{$100 \times 100$}}\end{axis}
\end{tikzpicture}}}
...
\legend{{$1M \times 1M$},{$10k \times 10k$},{$1k \times 1k$},{$100 \times 100$}}
\end{axis}
\end{tikzpicture}}}
...
\section{Experiments on the North Graph Testset}

\todo[inline]{Say something about north graph}
