...
On the other hand, the restricted variant of our algorithm, which does not allow the aspect ratio to decrease, has more or less comparable performace (in terms of the aspect ratio of the computed drawings) as the one of Huang et al.~\cite{DBLP:journals/vlc/HuangEHL13}.
